...
public class Oyuncu {
    ...
    static boolean son_tur_mu=false;
    ...
    Oyuncu(String oyuncuAdi,String oyuncuID){
    ...
    void SeviyeAyarlama(SavasAraclari kart){
    ...
    void kartSec(int adim){ // Bilgisayar kartlarindan rastgele 3 tane , oyuncu kartlarından kendi istediği 3 tanesini seçiyor
        SecilenKartlar.clear();
        int kullanilmiskart=0;
        for(int i=0;i<Kartlarin.size();i++){
            if(Kartlarin.get(i).kullanimsayisi==1)
                kullanilmiskart++;
        }
            ...
            for(int j=0;j<3;){
                ...
                if(Kartlarin.size()-kullanilmiskart>=3) {
                    if (!SecilenKartlar.contains(Kartlarin.get(sayi)) && Kartlarin.get(sayi).kullanimsayisi==0) {
                        ...
                        Kartlarin.get(sayi).kullanimsayisi++;
                        j++;
                    }
                }
                else{
    ...
    ArrayList<SavasAraclari> GetSecilenKartlar(){
        return SecilenKartlar;
    }
    ArrayList<SavasAraclari> GetKartlarin(){
        return Kartlarin;
    }
    boolean Kartlar_bitti_mi(){
    ...
    String DagitimdakiKartlariYazdir(){
        StringBuilder kartmetni = new StringBuilder();
